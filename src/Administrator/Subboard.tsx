...
function Subboard() {
  ...
  return (
    <div style={{ height: 400, width: '100%' }}>
      ...
      <Button onClick={handleOpenOne} variant="outlined" startIcon={<AirlineSeatReclineExtraIcon />}>
        出席確認
      </Button>
      <Modal
        open={openOne}
    ...
    <Box
      ...
      ></Box>
    <Box sx={{ display: 'flex', justifyContent: 'center' }}>
    <Button variant="contained" sx={{ color: '#FFFFFF' }}>出席確認</Button>
    </Box>
        </Box>
      </Modal>
      <Button onClick={handleOpenTwo} variant="outlined" startIcon={<EmailIcon />}>
        DM送信
      </Button>
      <Modal
        open={openTwo}
    ...
    <Box
      ...
      ></Box>
    <Box sx={{ display: 'flex', justifyContent: 'center' }}>
    <Button variant="contained" sx={{ color: '#FFFFFF' }}>DM送信</Button>
    </Box>
        </Box>
      </Modal>
